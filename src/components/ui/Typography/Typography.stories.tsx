...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Typography system from the IFMIS Figma design library. Headings use Google Sans Flex SemiBold; body uses Google Sans Flex Regular / Medium. All sizes and line-heights match Figma 1:1.",
      },
    },
  },
};
